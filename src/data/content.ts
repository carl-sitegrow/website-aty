export const homeContent = {
  ...
  styles: [
    { label: 'Objets insolites', tag: 'INSOLITE', href: '/cadeaux/insolites/' },
    { label: 'Créateurs locaux', tag: 'LOCAL', href: '/cadeaux/' },
    { label: 'Expériences', tag: 'EXPÉRIENCE', href: '/cadeaux/' },
    { label: 'Design', tag: 'DESIGN', href: '/cadeaux/' },
    { label: 'Gourmand', tag: 'GOURMAND', href: '/cadeaux/' },
  ],
  occasions: [
